...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('zumanji_testgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['zumanji.Project'])),
            ('revision', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['zumanji.Revision'])),
        ...
        db.send_create_signal('zumanji', ['TestGroup'])

        # Adding unique constraint on 'TestGroup', fields ['build', 'label']
        db.create_unique('zumanji_testgroup', ['build_id', 'label'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('zumanji_testgroup')
    ...
    models = {
        ...
        'zumanji.test': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['zumanji.TestGroup']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'zumanji.testgroup': {
            'Meta': {'unique_together': "(('build', 'label'),)", 'object_name': 'TestGroup'},
            'build': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['zumanji.Build']"}),
            'data': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
